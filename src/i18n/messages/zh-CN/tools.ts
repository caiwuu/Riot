...
export default {
  ...
  "tools.webFetch.image": "来自 {host} 的图片（{media}，{kb} KB）",

  // ── 工具描述：任务与计划 ─────────────────────────────
  "tools.todo.update": "更新任务清单（{count} 项）",
  "tools.todo.progress": "{done}/{total} 完成",
  "tools.todo.progressActive": "{done}/{total} 完成 · {active}",
  "tools.plan.create": "写计划「{name}」",
  "tools.plan.createAny": "写计划",
  "tools.plan.saved": "计划已保存到 {path}",
  "tools.mode.switchTo": "建议切到 {mode} 模式",
  "tools.mode.switchAny": "建议切换工作方式",
  "tools.mode.askSwitch": "模型建议切到 {mode} 模式",
