import { createFileViewerTranslator } from '../i18n/messages.js';
import { normalizeFileViewerPrintMaskRegion, normalizeFileViewerPrintStamp, } from './printMask.js';
...
`;
const ensureDesignerStyle = (root) => {
...
const toPercentRegion = (start, end, bounds, pageIndex) => {
...
const visibleArea = (element, viewport) => {
...
const readStampFileAsDataUrl = (file, windowRef) => new Promise((resolve, reject) => {
    ...
    const Reader = (windowRef === null || windowRef === void 0 ? void 0 : windowRef.FileReader) || globalThis.FileReader;
 ...
 */
export const openFileViewerPrintMaskDesigner = (options) => {
    const root = options.root;
    const documentRef = root.ownerDocument;
    const t = createFileViewerTranslator(options.i18n);
    const color = options.color || '#000000';
    const regions = [...(options.initialRegions || [])]
        .map(region => normalizeFileViewerPrintMaskRegion(region))
        .filter((region) => !!region);
    const stamps = [...(options.initialStamps || [])]
    ...
    const ensureOverlayContainingBlock = (element) => {
        var _a, _b, _c;
        const previousPosition = element.style.position;
        const computedPosition = ((_c = (_b = (_a = documentRef.defaultView) === null || _a === void 0 ? void 0 : _a.getComputedStyle) === null || _b === void 0 ? void 0 : _b.call(_a, element)) === null || _c === void 0 ? void 0 : _c.position) ||
            previousPosition ||
            'static';
    ...
    return new Promise(resolve => {
        ...
        const createSurface = (element, pageIndex) => {
        ...
        const surfaces = pageElements.map((element, index) => (createSurface(element, pageScoped ? index : undefined)));
        ...
        const renderRegions = () => {
            ...
            stamps.forEach((stamp, index) => {
                ...
                const applyStampStyle = () => {
                    ...
                    stampElement.style.opacity = String((_a = stamp.opacity) !== null && _a !== void 0 ? _a : 1);
                    stampElement.style.transform = `rotate(${(_b = stamp.rotate) !== null && _b !== void 0 ? _b : 0}deg)`;
                };
                applyStampStyle();
                ...
                stampElement.addEventListener('pointerdown', event => {
                    ...
                    (_a = stampElement.setPointerCapture) === null || _a === void 0 ? void 0 : _a.call(stampElement, event.pointerId);
                });
                ...
                const endInteraction = (event) => {
                    ...
                    try {
                        (_a = stampElement.releasePointerCapture) === null || _a === void 0 ? void 0 : _a.call(stampElement, interaction.pointerId);
                    }
                    catch {
        ...
        surfaces.forEach(surface => {
            ...
            surface.canvas.addEventListener('pointerup', event => {
                ...
                const end = pointFromEvent(event, surface.canvas);
                const region = toPercentRegion(drawing.start, end, surface.canvas.getBoundingClientRect(), surface.pageIndex);
        ...
        const getActiveSurface = () => {
            ...
            return ((_a = surfaces
                ...
                .sort((left, right) => right.area - left.area)[0]) === null || _a === void 0 ? void 0 : _a.surface) || surfaces[0];
        };
        addButton.addEventListener('click', () => {
            disarm();
            const activeSurface = getActiveSurface();
            activeSurface === null || activeSurface === void 0 ? void 0 : activeSurface.canvas.classList.add('is-armed');
        ...
        stampInput.addEventListener('change', async () => {
            var _a;
            const file = (_a = stampInput.files) === null || _a === void 0 ? void 0 : _a[0];
            stampInput.value = '';
            if (!file) {
                return;
            }
