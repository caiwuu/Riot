...
export const FILE_VIEWER_FALLBACK_LOCALE = 'en-US';
...
const normalizeLocaleCandidate = (locale) => {
...
export const normalizeFileViewerLocale = (locale) => {
...
const getCustomMessages = (input) => {
    var _a;
    return ((_a = input === null || input === void 0 ? void 0 : input.i18n) === null || _a === void 0 ? void 0 : _a.messages) || (input === null || input === void 0 ? void 0 : input.messages);
};
export const resolveFileViewerLocale = (input) => {
    var _a;
    return normalizeFileViewerLocale(((_a = input === null || input === void 0 ? void 0 : input.i18n) === null || _a === void 0 ? void 0 : _a.locale) || (input === null || input === void 0 ? void 0 : input.locale));
};
export const formatFileViewerMessage = (message, params = {}) => message.replace(/\{([a-zA-Z0-9_.-]+)\}/g, (_match, key) => {
    const value = params[key];
    return value === undefined || value === null ? '' : String(value);
});
export const translateFileViewerMessage = (input, key, params = {}) => {
    ...
    const customMessage = typeof customMessages === 'function'
        ...
        : customMessages === null || customMessages === void 0 ? void 0 : customMessages[key];
...
export const createFileViewerTranslator = (input) => {
    return (key, params) => translateFileViewerMessage(input, key, params);
};
