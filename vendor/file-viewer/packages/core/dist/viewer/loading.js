...
export const FILE_VIEWER_LOADING_THEME_MAP = {
    doc: {
        accent: '#2b78f6',
...
export const cloneFileViewerLoadingState = (state) => ({
...
export const applyFileViewerLoadingState = (target, source) => {
...
export const syncFileViewerLoadingControllerState = (target, controller, source = controller.getState()) => {
    return applyFileViewerLoadingState(target, source);
};
export const runFileViewerLoadingControllerAction = (target, action) => {
    return applyFileViewerLoadingState(target, action());
};
export const runFileViewerLoadingExtensionSync = ({ target, controller, extension, }) => {
    return runFileViewerLoadingControllerAction(target, () => controller.setExtension(extension));
};
export const createFileViewerLoadingControllerActionHandlers = (target, controller) => {
    return {
