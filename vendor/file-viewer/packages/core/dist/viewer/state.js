...
const extensionLabel = (extension, i18n) => {
...
const FILE_VIEWER_KNOWN_ERROR_MESSAGE_KEYS = {
...
export const normalizeFileViewerErrorMessage = (error, i18n) => {
...
export const formatFileViewerErrorMessage = (prefix, error, i18n) => {
...
export const createFileViewerErrorState = (extension = '', error = undefined, theme = DEFAULT_FILE_VIEWER_STATE_THEME, i18n) => createFileViewerStateDescriptor({
    state: 'error',
    extension,
