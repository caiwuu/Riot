...
function readSectorAbsolute(bytes, sectorSize, sid) {
...
function collectChain(startSid, nextSectorFn, limit = MAX_CHAIN_SECTORS) {
    const chain = [];
    const seen = new Set();
    let sid = startSid;
    let guard = 0;
...
function readChainBytes(bytes, sectorSize, startSid, fat, expectedSize = null) {
